...
class ProductController extends Controller
{
     ...
     * @const
     */
    const base_view_path = 'panel.application.products';
    ...
    public function index(Request $request)
    {
        ...
        //Get items
        $pagination = true;
        $rows = (new ProductRepository())->index($request->text_filter, $pagination);

        return view(self::base_view_path . '.index', compact('rows'));
    }
